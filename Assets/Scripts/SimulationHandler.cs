...
public class SimulationHandler : MonoBehaviour
{
    ...
    [SerializeField] public List<UnityEngine.Material> cubeMaterial = new List<UnityEngine.Material>(); //place this in SpawnCubeSystem
    [SerializeField] public Mesh cubeMesh; //place this in SpawnCubeSystem
   ...
   void ProcessUserInput() 
    ...
    private void Awake()
    {
        ...
        //cube = GetComponentGroup<Cube>();
        //cube = entityManager.GetComponent<Cube>();
       /* entityManager = World.DefaultGameObjectInjectionWorld.EntityManager;
...
/*
    ...
    private void SpawnCube(float x, float y, float z)
    {
        ...
        //entityManager.AddComponentData(newCubeEntity, new MaterialColor BORTKOMMENTERAT
        //{
